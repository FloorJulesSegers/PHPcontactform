  			...
  			<div class="col-md-6 col-md-offset-3">
				...
				<form class="form-horizontal" role="form" method="post" action="index.php">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="name" name="firstname" placeholder="First Name" value="<?php echo htmlspecialchars($_POST['firstname']); ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="name" name="lastname" placeholder="Last Name" value="<?php echo htmlspecialchars($_POST['lastname']); ?>">
